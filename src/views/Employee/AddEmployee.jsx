                    ...
                    properties={[
                      {
                        ...
                        defaultValue:
                          props.match.params.data == ":data" ? "" : employeeId,
                        disabled:
                          props.match.params.data == ":data" ? false : true,
                        onChange: (evt) => {
                      ...
                      },
                      {
                        ...
                        type: "text",
                        defaultValue:
                          props.match.params.data == ":data" ? "" : fullName,
                        bsClass: "form-control",
                  ...
                  <FormInputs
                    ...
                    properties={[
                      ...
                      },
                      {
                        ...
                        type: "text",
                        defaultValue:
                          props.match.params.data == ":data" ? "" : dateOfBirth,
                        bsClass: "form-control",
