...
class UserProfile extends Component {
  ...
  updateform = (val) => {
    ...
    if (this.state.selectedFile1) {
      ...
      new Apimanager()
        .PutrouteByid(`warehouse_manager/incomming_order/:order_id/orders/:_id/items/:item_id`, {recievedstatus:true})
        .then((res) => {
          if (res.status == 200) {
            this.setState({
              alert: (
  ...
  render() {
    var cat = this.state.item_id.split('-')
    cat = cat[0]
    return (
      <div className="content">
        ...
        {/* <QrCode  value={this.state._id}/> */}
                      ...
                      <Col xs={6} md={4}>
                        <Image
                          src={`${config.url}public/images/${this.state.picture_pathway}`}
                          roundedCircle
                      ...
                      <Col xs={6}>
                        ...
                        <div>
                          ...
                          value={this.state.item_colour}
                            ...
                            bsSize="large"
                            height={32}
                            title={this.state.cat_name || "Select A Colour"}
                          >
                          </DropdownButton>
                        </div>
                      </Col>
